  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Text('Review Your Advert', style: Theme.of(context).textTheme.headlineSmall),
          ...
          // Skills
          if (selectedSkills.isNotEmpty) _buildReviewSection(context, 'Skills Required', selectedSkills.toList()),
          ...
          if (selectedImage != null)
            _buildReviewSection(context, 'Image', [
              Container(
                ...
                child: ClipRRect(borderRadius: BorderRadius.circular(8), child: Image.file(selectedImage!, fit: BoxFit.cover)),
              ),
            ]),
              ...
              children:
                  items.map((item) {
                    if (item is Widget) {
                      ...
                      return Padding(padding: const EdgeInsets.symmetric(vertical: 2), child: Text(item.toString()));
                    }
                  }).toList(),
            ),
          ),
